...
test('formatDuration + relativeTime (the ONE relative-time vocabulary)', () => {
...
test('formatBytes (regression guard for the shared analytics formatter)', () => {
...
test('noun: the word alone ("1 objects" was shown in six places)', () => {
...
test('parentPrefix (keyboard "up a folder" navigation)', () => {
