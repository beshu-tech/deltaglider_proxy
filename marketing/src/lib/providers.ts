...
export const PROVIDERS: Provider[] = [
  ...
  },
  {
    ...
    name: 'iDrive e2',
    currency: 'USD',
    notes: 'You pay for at least 1 TB, even if you store less.',
  ...
  },
  {
    ...
    currency: 'EUR',
    notes: 'You pay for at least 1 TB, even if you store less. Prices are in €.',
  ...
  },
  {
    ...
    name: 'Cloudflare R2',
    currency: 'USD',
    notes: 'The first 10 GB are free, and there are no egress fees.',
  ...
  },
  {
    ...
    currency: 'USD',
    notes: 'This is the rate for the first 50 TB tier. Egress and API requests cost extra.',
  ...
  },
  {
    ...
    name: 'GCP Standard',
    currency: 'USD',
    notes: 'This is the us-central1 rate. Egress costs extra.',
  ...
  },
  {
    ...
    name: 'Azure Blob Hot',
    currency: 'USD',
    notes: 'This is the East US rate. Egress costs extra.',
  ...
  },
  {
    ...
    currency: 'USD',
    notes: 'Retrieval costs extra and is delayed.',
    archive: true,
  ...
  },
  {
    ...
    currency: 'USD',
    notes: 'You pay for at least 180 days of storage, and a retrieval takes up to 12 hours.',
    archive: true,
