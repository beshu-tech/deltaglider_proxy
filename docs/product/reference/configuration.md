...
| `DGP_PARITY_MAX_OBJECTS` | 200000 | Max objects a Verify audit scans across both sides before it caps and reports a partial ("scan capped") result; raise for buckets larger than ~100k objects (min 1000) |
