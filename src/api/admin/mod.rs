...
pub use config::{
    ...
    recover_db, sync_now, test_s3_connection, trace_config, trace_config_get, update_config,
    validate_config_doc, validate_declarative_iam, validate_section, BackendInfoResponse,
